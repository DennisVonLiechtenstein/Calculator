...
export default function App() {
  ...
  function calculator() {
    ...
    if(lastArr === '/' || lastArr === '*' || lastArr === '-' || lastArr === '+' || lastArr === '.') {
      ...
      let resultado = (currentNumber + lastNumber);

    }
    else {
      let result = eval(currentNumber).toString();
      let resultado = (currentNumber)
    ...
    <View>
      ...
      <View style={styles.buttons}>                                               
        {buttons.map((button) =>
          ...
          <TouchableOpacity key={button} style={[styles.button, {backgroundColor: 'red'} ]} onPress={() => handleInput(button)}>
